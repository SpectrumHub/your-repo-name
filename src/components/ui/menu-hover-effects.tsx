      ...
      `}>
        ...
        `}>
          ...
          <li className="list-none">
            ...
            >
              <span className="
                relative z-10 block uppercase text-white bg-[#262626] rounded-full px-6 py-2 font-sans font-semibold transition-colors duration-300
                group-hover:bg-[#444] group-hover:text-white
                text-xl md:text-base lg:text-lg
              ">
                Contact Us
              </span>
              {/* Top & bottom border animation */}
